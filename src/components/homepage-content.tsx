...
export default function HomePageContent({ featuredProducts }: { featuredProducts: Product[] }) {
          ...
          <div className="container relative z-10">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {featuredProducts.map((product) => (
                <div key={product.id} className="group relative bg-card hover:bg-card/80 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1">
                  ...
                  <div className="p-6 flex flex-col">
                    <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors">
                      <Link href={`/products/${product.id}`} className="hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
                        {product.title}
                      </Link>
                    </h3>
                    ...
                    <div className="mt-auto">
                      <RainbowButton
                        ...
                        variant="dark"
                        className="w-full flex items-center justify-center gap-2 text-sm py-4 transition-all"
                      >
